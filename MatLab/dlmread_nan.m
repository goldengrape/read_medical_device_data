function result= dlmread_nan(filename,delimiter,r,c,range)
%This is a MODIFIED version of DLMREAD, 
%based on https://stackoverflow.com/questions/23552162/matlab-read-file-with-varying-line-lengths
%change 'emptyvalue' to NaN
